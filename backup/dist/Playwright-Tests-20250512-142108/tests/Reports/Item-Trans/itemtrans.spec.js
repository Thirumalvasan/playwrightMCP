...
async function clickDateFilterOption(menuLocator, optionText) {
...
(0, test_1.test)('verify Item Transactions Report page loads correctly', async ({ page }) => {
    ...
    await (0, test_1.expect)(page.getByRole('heading', { name: /Item Transaction/i })).toBeVisible();
...
//# sourceMappingURL=itemtrans.spec.js.map